...
<body <?php body_class(); ?> id="body_new2016theme">
  ...
  ?>
  <div id="main_wrap" style="background-size:cover;background-position:top center;background-image:url('<?php echo get_stylesheet_directory_uri(); ?>/assets/img/parapetods/parapet-hero-bg.jpg')">
    <div class="call-to-action-box relative">
			...
			<img id="parapet-splash" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/parapetods/app-and-camera-splash.png">
      <div class="container">
        <div class="row">
          <div class="col-sm-6 text-left" style="padding-left:25px;">
						<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/parapetods/envysion-overseer-rev.png" style="max-width:350px">
  ...
  <div class="container" id="first_section">
    <div class="row more_padding" style="">
      <div class="col-md-10 col-centered text-center">
        ...
        <h3 class="no_top_margin">Envysion and Parapet Studios, two technology leaders in the QSR industry, have teamed up to unveil a powerful, integrated loss prevention solution that saves time and maximizes efficiency for KFC operators.</h3>
        <br>
      </div>
    </div>
		<div class="row " style="">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="text-center">
              <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/parapetods/eye-icon.svg" width="80">
          ...
          <div class="col-md-4">
            <div class="text-center">
              <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/parapetods/checklist-icon.svg" width="80">
              <h3>Save Time</h3>
              <p>Forget sifting through stacks of exception reports and focus on those few events that truly impact your bottom line. </p>
					...
					<div class="col-md-4">
            <div class="text-center">
              <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/parapetods/clock-icon.svg" width="80">
              <h3>Save Money</h3>
  ...
  <div class="gray_wrap overflow-hidden relative">
    <div class="container">
      <div class="row more_padding">
        ...
        <div class="col-md-8 text-center">
          ...
          <p class="callout-p">Don’t rely on either video or transaction data alone to uncover loss—use both to make your investigations airtight. With Parapet’s customizable exception-based reporting and incident tracking workflow paired with Envysion’s powerful and reliable managed video solution, restaurant operators can arrive at firm conclusions and take immediate action to reduce loss because video and transaction data are displayed side-by-side.</p>
        </div>
      </div>
    </div>
  </div>
	<div class="container even_more_bottom_margin">
		...
		<div class="formula-box formula-box-equals">
			<div class="row">
				<div class="col-sm-6 text-center">
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/parapetods/overseer-darker.png" style="margin-top:10px;">
					<h3 class="pn_reg_bold_italic bluetext">Loss Prevention Solution</h3>
				</div>
				<div class="col-sm-6">
					<ul class="checkmark-list">
						<li>Proactive detection of suspicious activities via customizable reports</li>
						<li>Incident tracking  & usage analytics to ensure resolution</li>
					</ul>
				</div>
			</div>
		</div>
  ...
  <?php get_template_part('templates/footer-parapet'); ?>
  </div>
</body>
</html>
