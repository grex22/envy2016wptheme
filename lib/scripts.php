...
function roots_scripts() {
  ...
  wp_register_script('wistiapopover', '//fast.wistia.net/static/popover-v1.js', false, null, false);
	...
	//wp_register_script('masonry', get_template_directory_uri() .'/assets/js/vendor/masonry.min.js', false, null, false);
	wp_register_script('isotope', get_template_directory_uri() .'/assets/js/vendor/isotope.min.js', false, null, false);
